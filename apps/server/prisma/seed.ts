    ...
    data: [
      {
        ...
        name: "Nike",
        description:
          "Nike không chỉ là biểu tượng của sự đổi mới và hoàn thiện mà còn là nguồn cảm hứng cho vận động viên trên khắp thế giới",
      ...
      },
      {
        ...
        name: "Adidas",
        description:
          "Adidas được biết đến với sự kết hợp hoàn hảo giữa thiết kế và công nghệ",
      ...
      },
      {
        ...
        name: " Under Armour",
        description:
          "Under Armour ban đầu được biết đến với quần áo thể thao hiệu suất cao",
      ...
      },
      {
        ...
        name: "Reebok",
        description:
          "Reebok không ngừng nỗ lực mang đến cho người dùng những trải nghiệm tốt nhất qua từng sản phẩm.",
